...
namespace WindowsFormsApplication4
{
    public partial class Form1 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (!panel5.Controls.Contains(Reminder.Instance))
            {
                panel5.Controls.Add(Reminder.Instance);
                Reminder.Instance.Dock = DockStyle.Fill;
                Reminder.Instance.BringToFront();
            }
            else
                Reminder.Instance.BringToFront();
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            if (!panel5.Controls.Contains(Training.Instance))
            {
                panel5.Controls.Add(Training.Instance);
                Training.Instance.Dock = DockStyle.Fill;
                Training.Instance.BringToFront();
            }
            else
                Training.Instance.BringToFront();
        }
